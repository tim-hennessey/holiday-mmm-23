...
app.Animation = (function () {
	...
	function initialize() {
		...
		// buttonCta.addEventListener('mouseover', function () {
  //           tl1.to(cta, .05, {x:"-=3", yoyo:true, repeat:-1, ease:Sine.easeInOut})

  //       });
  //       buttonCta.addEventListener('mouseout', function () {
  //           t.to(cta, .05, {x:0, ease:Sine.easeInOut});
  ...
  //       });
	...
	function start() {
		...
		tl2.to(txt1, .5, {opacity:1, ease:Sine.easeOut})
		.to(txt1, .5, {opacity:0}, "+=1.5")

		.to(txt2, .5, {opacity:1, ease:Sine.easeOut})
		.to(txt2, .5, {opacity:0}, "+=1.5")

		.to(txt3, .5, {opacity:1, ease:Sine.easeOut})
