...
app.Animation = (function () {
	...
	function start() {
		...
		.to(txt1, .5, {x:"+=160", opacity:0, ease:Sine.easeIn}, "+=1.5")

		.to(txt2, .5, {x:"+=160", ease:Sine.easeOut})
		.to(txt2, .5, {x:"+=160", opacity:0, ease:Sine.easeIn}, "+=1.5")

		.to(img, .5, {y:"+=600", ease:Sine.easeIn}, "-=.5")
		// .to(img, .5, {autoAlpha: 0, ease:Sine.easeIn}, "-=.5")
		.to(txt3, .5, {x:"+=160", ease:Sine.easeOut});
